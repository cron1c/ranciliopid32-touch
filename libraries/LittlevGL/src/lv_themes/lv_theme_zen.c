...
static void basic_init(void)
{
    ...
    def.text.font       = _font;
    //bg.text.color      = lv_color_hsv_to_rgb(_hue, 0, 100);
    bg.text.color      = lv_color_hex(0x85C6FF);
    bg.image.color = lv_color_hex(0x85C6FF);
    //bg.image.color     = lv_color_hsv_to_rgb(_hue, 5, 95);

    lv_style_copy(&bg, &def);
    //bg.body.main_color   = lv_color_hsv_to_rgb(_hue, 11, 30);
    bg.body.main_color   = lv_color_hex(0x1C5180);
    //bg.body.grad_color   = lv_color_hsv_to_rgb(_hue, 11, 30);
    bg.body.grad_color   = lv_color_hex(0x426380);
    bg.body.radius       = 0;
    ...
    panel.body.border.color = lv_color_hex(0x2D82CC);
    panel.body.border.opa     = LV_OPA_COVER;
    panel.body.shadow.width   = 4;
    panel.body.shadow.color   = lv_color_hex(0x426380);//0xddd);
...
static void btn_init(void)
{
    ...
    rel.body.shadow.color   = lv_color_hex3(0x000);
    ...
    rel.text.color          = lv_color_hex3(0xeee);
    rel.image.color         = lv_color_hex3(0xeee);
...
static void btnm_init(void)
{
    ...
    pr.body.radius       = LV_RADIUS_CIRCLE;//LV_DPI / 1;
    ...
    ina.body.radius = LV_RADIUS_CIRCLE;
...
static void tabview_init(void)
{
    ...
    btn_bg.body.border.part  = LV_BORDER_TOP;
   // btn_bg.body.border.color = lv_color_hsv_to_rgb(_hue, 10, 90);
    btn_bg.body.border.color = lv_color_hex(0x85C6FF);

    lv_style_copy(&indic, &def);
    indic.body.padding.inner = LV_DPI / 70;
    indic.body.border.width  = 0;
    indic.body.radius        = 0;
